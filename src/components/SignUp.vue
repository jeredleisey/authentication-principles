      ...
      <form action="#" method="POST" class="mt-8 space-y-6">
        ...
        <div class="-space-y-px rounded-md shadow-sm">
          ...
          <div>
            ...
            <input
              ...
              required
              class="relative block w-full appearance-none rounded-none border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-amber-500 focus:outline-none focus:ring-amber-500 sm:text-sm"
        ...
        <div>
          <button
            ...
            @click.prevent="createAcct(email, password)"
          >
